...
- `SIZE` can be any power of 2 from 8 to 512 (larger powers can be generated using the [provided python script](/script/generate_floatarray.py))

## Effects
* [com_floatarray_initialize](#effect-com_floatarray_initialize)
* [com_floatarray_get](#effect-com_floatarray_get)
* [com_floatarray_set](#effect-com_floatarray_set)
* [com_floatarray_set_index](#effect-com_floatarray_set_index)
* [com_floatarray_set_value](#effect-com_floatarray_set_value)
* [com_floatarray_foreach](#effect-com_floatarray_foreach)
* [com_floatarray_clear](#effect-com_floatarray_clear)

## Triggers
* [com_floatarray_check_size](#trigger-com_floatarray_check_size)
